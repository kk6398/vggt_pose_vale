...
def load_poses_oringinal(path, max_length, stride):
    ...
    c2ws = c2ws[::stride]     # 按步长stride对位姿数组进行下采样，例如stride=2表示每隔一个位姿取一个，减少数据量。
    return c2ws
...
if __name__ == '__main__':
    ...
    # all_cam_to_world_mat.append(extrinsic[0,:,:])       # .extend 是添加多个元素
    ...
    print("traj_est_poses:=====", traj_est_poses)     
